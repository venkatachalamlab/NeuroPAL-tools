...
%     trackName = char(fstTr.getAttribute('name'));
%     skeletonId = str2double(trackName(7:end));
...
%        parId = getNumericalAttribute(attr, 'SPOT_SOURCE_ID'); VV
%        chId = getNumericalAttribute(attr, 'SPOT_TARGET_ID'); VV
       chId = getNumericalAttribute(attr, 'SPOT_SOURCE_ID');
       parId = getNumericalAttribute(attr, 'SPOT_TARGET_ID');
